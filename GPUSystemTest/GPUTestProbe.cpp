...
GPUTestProbe::GPUTestProbe(const char * probeName, HyPerCol * hc)
: StatsProbe()
{
}
...
int GPUTestProbe::initGPUTestProbe_base() { return PV_SUCCESS; }

int GPUTestProbe::initGPUTestProbe(const char * probeName, HyPerCol * hc) {
