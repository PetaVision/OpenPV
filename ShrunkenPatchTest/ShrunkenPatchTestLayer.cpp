...
ShrunkenPatchTestLayer::ShrunkenPatchTestLayer(const char * name, HyPerCol * hc, int numChannels) : ANNLayer() {
...
int ShrunkenPatchTestLayer::initialize(const char * name, HyPerCol * hc, int numChannels){
