...
echo ${exe_path[0]}
input_path=${clique_path}"input/Heli/Training/Car2/canny3way/mask/"
echo ${input_path[0]}
input_prefix="Heli_Training_Car2_canny3way_mask_"
output_path="/mnt/data/repo/neovision-programs-petavision/Heli/Training/activity/Car2/canny3way/mask/"
output_prefix="Heli_Training_Car2_canny3way_mask_"
version_id=0; #0
version_IDs=({001..016})
echo ${version_IDs[*]}
