...
echo ${exe_path[0]}
input_path=${clique_path}"input/Heli/Training/distractor2/canny/distractor/"
echo ${input_path[0]}
input_prefix="Heli_Training_distractor2_canny_distractor_"
output_path="/mnt/data/repo/neovision-programs-petavision/Heli/Training/activity/distractor2/canny/distractor/"
output_prefix="Heli_Training_distractor2_canny_"
version_id=0;
version_IDs=({001..016})
echo ${version_IDs[*]}
