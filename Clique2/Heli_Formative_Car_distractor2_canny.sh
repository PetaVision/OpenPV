...
echo ${exe_path[0]}
input_path=${clique_path}"input/Heli/Formative/Car_distractor2/canny/mask/"
echo ${input_path[0]}
input_prefix="Heli_Formative_Car_distractor2_canny_mask_"
output_path="/mnt/data/repo/neovision-programs-petavision/Heli/Formative/activity/Car_distractor2/canny/mask/"
output_prefix="Heli_Formative_Car_distractor2_canny_mask"
version_id=0;
version_IDs=({001..016})
echo ${version_IDs[*]}
