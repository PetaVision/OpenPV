...
echo ${exe_path[0]}
input_path=${clique_path}"input/Heli/Challenge/Car2/canny/"
echo ${input_path[0]}
input_prefix="Heli_Challenge_Car2_canny_"
output_path="/mnt/data/repo/neovision-programs-petavision/Heli/Challenge/activity/Car2/canny/"
output_prefix="Heli_Challenge_Car2_canny_"
version_id=0;
