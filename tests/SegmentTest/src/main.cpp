...
int main(int argc, char *argv[]) {
   ...
   // etc.
   //
   pv_initObj.registerKeyword("AssertZerosProbe", Factory::create<AssertZerosProbe>);
   pv_initObj.registerKeyword("SegmentTestLayer", Factory::create<SegmentTestLayer>);
   pv_initObj.registerKeyword("SegmentifyTest", Factory::create<SegmentifyTest>);
