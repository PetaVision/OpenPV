...
int main(int argc, char * argv[]) {
   ...
   pv_initObj.registerKeyword("HyPerConnDebugInitWeights", Factory::create<HyPerConnDebugInitWeights>);
   ...
   pv_initObj.registerKeyword("KernelConnDebugInitWeights", Factory::create<KernelConnDebugInitWeights>);
