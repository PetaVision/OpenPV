...
int main(int argc, char *argv[]) {
   ...
   FatalIf(
         configParser.getBooleanArgument("RequireReturn") != true,
         "Parsing RequireReturn failed.\n");
   ...
   FatalIf(
         configParser.getUnsignedIntArgument("RandomSeed") != 1234565432U,
         "Parsing RandomSeed failed.\n");
   ...
   FatalIf(
         configParser.getStringArgument("OutputPath") != "outputPath",
         "Parsing OutputPath failed.\n");
   FatalIf(
         configParser.getStringArgument("ParamsFile") != "input/pv.params",
         "Parsing ParamsFile failed.\n");
   ...
   FatalIf(
         configParser.getStringArgument("WorkingDirectory") != ".", "Parsing WorkingDir failed.\n");
   FatalIf(
         configParser.getStringArgument("CheckpointReadDirectory") != "outputPath/checkpoints",
         "Parsing CheckpointReadDirectory failed.\n");
   return 0;
}
