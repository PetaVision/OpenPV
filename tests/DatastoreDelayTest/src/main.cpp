...
int main(int argc, char * argv[]) {
    ...
    initObj.registerKeyword("DatastoreDelayTestLayer", Factory::standardCreate<DatastoreDelayTestLayer>);
    initObj.registerKeyword("DatastoreDelayTestProbe", Factory::standardCreate<DatastoreDelayTestProbe>);
