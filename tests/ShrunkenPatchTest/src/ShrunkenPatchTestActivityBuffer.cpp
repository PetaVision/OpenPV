...
ShrunkenPatchTestActivityBuffer::ShrunkenPatchTestActivityBuffer(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

ShrunkenPatchTestActivityBuffer::~ShrunkenPatchTestActivityBuffer() {}

void ShrunkenPatchTestActivityBuffer::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
