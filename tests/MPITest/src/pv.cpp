...
int main(int argc, char * argv[]) {
   ...
   // etc.
   //
   pv_initObj.registerKeyword("MPITestProbe", Factory::standardCreate<MPITestProbe>);
   pv_initObj.registerKeyword("MPITestLayer", Factory::standardCreate<MPITestLayer>);
