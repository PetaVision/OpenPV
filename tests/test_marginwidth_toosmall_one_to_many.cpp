/*
 * test_marginwidth_toosmall_one_to_many.cpp
 * Tests HyPerCol::checkPatchSize() (a private method called by HyPerCol::run(int) )
 * on a one-to-many connection where the margin width is too small.
...
int main(int argc, char * argv[])
{
   ...
   cl_args[1] = strdup("-p");
   cl_args[2] = strdup("input/test_marginwidth_toosmall_one_to_many.pv");
