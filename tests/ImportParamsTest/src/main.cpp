...
int main(int argc, char * argv[]) {
   ...
   // etc.
   //
   pv_initObj.registerKeyword("ImportParamsLayer", Factory::standardCreate<ImportParamsLayer>);
   pv_initObj.registerKeyword("ImportParamsConn", Factory::standardCreate<ImportParamsConn>);
