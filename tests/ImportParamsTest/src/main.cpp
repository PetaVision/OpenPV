...
int main(int argc, char *argv[]) {
   ...
   // etc.
   //
   pv_initObj.registerKeyword("ImportParamsLayer", Factory::create<ImportParamsLayer>);
   pv_initObj.registerKeyword("ImportParamsConn", Factory::create<ImportParamsConn>);
