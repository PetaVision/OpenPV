...
DelayTestProbe::DelayTestProbe(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm)
      : StatsProbeImmediate() {
...
void DelayTestProbe::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
