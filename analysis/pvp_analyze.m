...
image_filename = [input_path 't/tar_0003_a.png'];
target_filename{1} = [input_path 'a/tar_0003_a.png'];
    ...
    for i_target = 1:num_targets
	  ...
	  rate_array{layer}(1,target_ndx_all{layer, i_target});
        target_rate_array_tmp = ...
            sparse(1, target_ndx_all{layer, i_target}, target_rate{layer, i_target}, 1 , N, num_target_neurons_max(layer, i_target) );
