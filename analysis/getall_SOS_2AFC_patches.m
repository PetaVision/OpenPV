...
SOS_path = "/Users/gkenyon/MATLAB/patches/patch_exp2/";
SOS_results_path = [SOS_path, "results/"];
SOS_invalid_path = [SOS_results_path, "invalid/"];
mkdir(SOS_invalid_path);

global SOS_analysis_path
SOS_analysis_path = [SOS_path, "analysis/"];
mkdir(SOS_analysis_path);
...
remake_SOS_struct = 1;
read_exp_list = ~exist(SOS_struct_filename, "file") || remake_SOS_struct
if read_exp_list
  ...
  for ID = 1 : SOS_struct.num_SOS_IDs
	...
	psycho_2AFC(exp_struct_tmp, SOS_path);
