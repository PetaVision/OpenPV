...
plot(t_hardcostfunc, 0.025*hardcostfunc, 'g');
...
plot(t_softcostfunc, 0.025*softcostfunc, 'g');
...
plot(t_firmcostfunc, 0.025*firmcostfunc, 'g');
...
plot(t_istacostfunc, 0.025*istacostfunc, 'g');
