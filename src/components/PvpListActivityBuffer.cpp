...
PvpListActivityBuffer::PvpListActivityBuffer(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

PvpListActivityBuffer::~PvpListActivityBuffer() {}

void PvpListActivityBuffer::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   InputActivityBuffer::initialize(paramsIO, comm);
}
