...
HyPerInternalStateBuffer::HyPerInternalStateBuffer(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

HyPerInternalStateBuffer::~HyPerInternalStateBuffer() {}

void HyPerInternalStateBuffer::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
