...
void PatchSize::ioParam_nxp(enum ParamsIOFlag ioFlag) {
   parameters()->ioParamValue(ioFlag, getName(), "nxp", &mNxp, mNxp, false /*warnIfAbsentFlag*/);
...
void PatchSize::ioParam_nyp(enum ParamsIOFlag ioFlag) {
   parameters()->ioParamValue(ioFlag, getName(), "nyp", &mNyp, mNyp, false /*warnIfAbsentFlag*/);
...
void PatchSize::ioParam_nfp(enum ParamsIOFlag ioFlag) {
   parameters()->ioParamValue(ioFlag, getName(), "nfp", &mNfp, mNfp, false /*warnIfAbsentFlag*/);
