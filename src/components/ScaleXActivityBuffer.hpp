#ifndef SCALEXACTIVITYBUFFER_HPP_
#define SCALEXACTIVITYBUFFER_HPP_
...
/**
 * A layer activity component to stretch or contract in the x-direction.
 ...
 * are independent.
 */
class ScaleXActivityBuffer : public HyPerActivityBuffer {
  protected:
   /**
    * List of parameters used by the ScaleXActivityBuffer class
    * @name ScaleXLayer Parameters
    * @{
    */
  ...
  public:
   ScaleXActivityBuffer(char const *name, PVParams *params, Communicator const *comm);
...
#endif // SCALEXACTIVITYBUFFER_HPP_
