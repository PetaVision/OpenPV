...
SegmentBuffer::SegmentBuffer(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

SegmentBuffer::SegmentBuffer() {}

void SegmentBuffer::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
