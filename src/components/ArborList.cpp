...
ArborList::ArborList(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
...
void ArborList::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
