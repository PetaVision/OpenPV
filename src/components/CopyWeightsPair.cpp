...
CopyWeightsPair::CopyWeightsPair(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

CopyWeightsPair::~CopyWeightsPair() {}

void CopyWeightsPair::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
