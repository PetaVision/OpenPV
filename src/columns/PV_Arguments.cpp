...
char **PV_Arguments::getArgsCopy() const { return copyArgs(numArgs, args); }
...
char const *
PV_Arguments::setString(char **parameter, char const *string, char const *parameterName) {
