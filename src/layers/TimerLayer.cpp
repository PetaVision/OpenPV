...
void TimerLayer::fillComponentTable() {
   // Deliberately do not call BaseLayer::fillComponentTable() since many components are absent
...
void TimerLayer::initMessageActionMap() {
   // Deliberately bypass BaseLayer::initMessageActionMap() since many messages are inapplicable
