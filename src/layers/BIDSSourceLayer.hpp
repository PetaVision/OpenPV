...
#ifndef BIDSSOURCELAYER_HPP_
#define BIDSSOURCELAYER_HPP_
...
class BIDSSourceLayer : public PV::ANNLayer {
public:
   BIDSSourceLayer(const char* name, HyPerCol * hc, int numChannels=MAX_CHANNELS);
   virtual ~BIDSSourceLayer();
