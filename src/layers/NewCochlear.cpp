...
namespace PV {
    ...
    NewCochlearLayer::NewCochlearLayer(const char * name, HyPerCol * hc) {
        initialize_base();
        initialize(name, hc);
    }  // end NewCochlearLayer::NewCochlearLayer(const char *, HyPerCol *)
    ...
    int NewCochlearLayer::initialize(const char * name, HyPerCol * hc) {
    ...
    int NewCochlearLayer::communicateInitInfo(){
        HyPerLayer::communicateInitInfo();
        return PV_SUCCESS;
    }
    
    int NewCochlearLayer::allocateDataStructures(){
        HyPerLayer::allocateDataStructures();
