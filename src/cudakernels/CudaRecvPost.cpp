...
void CudaRecvPost::setArgs(
   ...
   status = cudnnSetFilter4dDescriptor_v3(filterDescriptor, CUDNN_DATA_FLOAT,
   ...
   if(out_n != nbatch || out_h != nyRes/params.manyScaleY || out_w != nxRes/params.manyScaleX || out_c != nf*params.manyScaleX*params.manyScaleY){
      ...
      errmsg << "Dimensions of output tensor (n, y, x, f): " << out_n << ", " << out_h << ", " << out_w << ", " << out_c << "\n";
      errmsg << "Scaled dimensions of output PV layer (n, y, x, f): " << nbatch << ", " << nyRes/params.manyScaleY << ", " << nxRes/params.manyScaleX << ", " << nf*params.manyScaleX*params.manyScaleY << "\n";
      errmsg << "Actual dimensions of output PV layer (n, y, x, f): " << nbatch << ", " << nyRes << ", " << nxRes << ", " << nf << "\n";
