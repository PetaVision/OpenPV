...
LayerInputDelivery::LayerInputDelivery(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

void LayerInputDelivery::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
