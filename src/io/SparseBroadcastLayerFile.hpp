/*
 * SparseBroadcastLayerFile.hpp
 */

#ifndef SPARSEBROADCASTLAYERFILE_HPP_
#define SPARSEBROADCASTLAYERFILE_HPP_
 ...
 */
class SparseBroadcastLayerFile : public CheckpointerDataInterface {
  public:
   SparseBroadcastLayerFile(
   ...
   SparseBroadcastLayerFile() = delete;
...
#endif // SPARSEBROADCASTLAYERFILE_HPP_
