...
AdaptiveTimeScaleProbeOutputter::AdaptiveTimeScaleProbeOutputter(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
   initialize(paramsIO, comm);
}

void AdaptiveTimeScaleProbeOutputter::initialize(std::shared_ptr<ParamsIO> paramsIO, Communicator const *comm) {
