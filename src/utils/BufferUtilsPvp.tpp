...
WeightHeader buildWeightHeader(
   ...
   baseHeader.nx         = preLayerWidth;
   baseHeader.ny         = preLayerHeight;
   baseHeader.nf         = preLayerFeatures;
   baseHeader.numRecords = numArbors;

   const int numPatchItems     = nxp * nyp * nfp;
   const std::size_t patchSize = weightPatchSize<T>(numPatchItems);

   baseHeader.recordSize = numPatches * patchSize;
   baseHeader.dataSize   = sizeof(T);
   baseHeader.dataType   = dataType;
   baseHeader.nxProcs    = 1;
   baseHeader.nyProcs    = 1;
   baseHeader.nxGlobal   = preLayerWidth;
   baseHeader.nyGlobal   = preLayerHeight;
   baseHeader.kx0        = 0;
   baseHeader.ky0        = 0;
   baseHeader.nBatch     = batchWidth;
