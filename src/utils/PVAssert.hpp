...
/**
 * Replacement for the assert() macro. By default, assert() is compiled out in non-release builds. We
 * can stop that behavior by redefining Release compiler arguments, but this introduces compiler portability
 * issues.
 *
 ...
 *
 * Also, by providing a PetaVision implementation of this macro, an opportunity to handle sending assert failures
