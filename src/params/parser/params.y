...
%token <sval> T_ID
%token <sval> T_OVERWRITE_TAG
%token <sval> T_ID_REMOVE
%token <dval> T_NUMBER
...
pvparams_directive : T_ID '=' T_NUMBER ';'
                   ...
                   | T_ID '=' T_FILENAME ';'
                         { handler->action_pvparams_filename_directive($1, $3); }
                   ;
...
parameter_defs : /* empty */
               ...
               | parameter_defs parameter_remove
...
parameter_array_def : T_ID '=' parameter_array ';'
                    ...
                    | T_OVERWRITE_TAG T_ID '=' parameter_array ';'
                            { handler->action_parameter_array_overwrite($2); }
                    ;

parameter_array : '[' parameter_array_values ']'

parameter_array_values : /* empty */
...
parameter_def : T_ID '=' T_NUMBER ';'
                 { handler->action_parameter_numeric_def($1, $3); }
              | T_OVERWRITE_TAG T_ID '=' T_NUMBER ';'
                 { handler->action_parameter_numeric_def_overwrite($2, $4); }
              ;
...
parameter_string_def : T_ID '=' T_STRING ';'
                     ...
                     | T_ID '=' T_GROUPID ';'
                        { handler->action_parameter_filename_def($1,$3); }
                     | T_OVERWRITE_TAG T_ID '=' T_STRING ';'
                        { handler->action_parameter_string_def_overwrite($2,$4); }
                     | T_OVERWRITE_TAG T_ID '=' T_FILENAME ';'
                        { handler->action_parameter_filename_def_overwrite($2,$4); }
                     | T_OVERWRITE_TAG T_ID '=' T_GROUPID ';'
                        { handler->action_parameter_filename_def_overwrite($2,$4); }
                     ;

parameter_remove : T_ID_REMOVE T_ID ';'
                       { handler->action_parameter_remove($2); }
                 ;
