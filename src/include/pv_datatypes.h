...
// Defines datatypes for connection weights, activity buffers, membrane potentials, and GSyn
// buffers.
//
// Currently, only float is supported for all these types.
//
// This file is included by OpenCL kernels as well as C and C++ source files, so should be kept to
