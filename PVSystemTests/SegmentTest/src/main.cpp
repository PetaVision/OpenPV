...
int main(int argc, char * argv[]) {
   ...
   // etc.
   pv_initObj.registerKeyword("AssertZerosProbe", createAssertZerosProbe);
   pv_initObj.registerKeyword("SegmentTestLayer", createSegmentTestLayer);
   pv_initObj.registerKeyword("SegmentifyTest", createSegmentifyTest);
