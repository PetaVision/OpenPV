...
LOGDIR=/nh/compneuro/Data/vine/LCA/2013_01_31/output_2013_01_31_12x12x128_lambda_05X2_noPulvinar
LOGFILE=${LOGDIR}/LCA_vine_2013_01_31_12x12x128_lambda_05X2_noPulvinar.log
mkdir -p ${LOGDIR}
touch ${LOGFILE}
echo ${LOGFILE}
