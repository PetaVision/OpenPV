...
if border_padding > 0
  if ~imageNet_synset_flag
    ...
    resized_list = [VOC_dataset_path, filesep, VOC_dataset, "_", imageNet_wnid, "_", "_padded", ...
		  num2str(border_padding), '_',  orientation_type, "_list.txt"];
  endif
else
  if ~imageNet_synset_flag
    ...
    resized_list = [VOC_dataset_path, filesep, VOC_dataset, "_", imageNet_wnid, '_',  orientation_type, "_list.txt"];
  endif
endif
