...
plot_flag = true;
output_dir = "~/workspace/PASCAL_VOC/PASCAL_S1_96_SLP/VOC2007_landscape3_SLP";

%% draw reconstructed image
%%DoG_weights = [];
%%Recon_list = {["a4_"],  ["ImageRecon"]};
...
%% sparse activity
%%Sparse_list ={["a0_"], ["S1"];  ["a2_"],  ["GroundTruth"]}; 
Sparse_list ={["a2_"],  ["GroundTruth"]}; 
...
pred_classID_file = fullfile("~/workspace/PASCAL_VOC/PASCAL_S1_96_SLP/VOC2007_landscape2_SLP/a3_Recon.pvp")
gt_classID_file = fullfile("~/workspace/PASCAL_VOC/PASCAL_S1_96_SLP/VOC2007_landscape2_SLP/a2_GroundTruth.pvp")
...
for i_frame = 1 : min(true_num_frames, pred_num_frames)
    ...
    %% ground truth layer is not sparse
