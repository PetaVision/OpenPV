...
macro(pv_config_project)
  ...
  if (${CMAKE_CXX_COMPILER_ID} STREQUAL "Intel")
    ...
    set(PV_CPP_FLAGS ${ICC_CPP_FLAGS})
  ...
  elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "IntelLLVM")
    ...
    set(PV_CPP_FLAGS ${INTELLLVM_CPP_FLAGS})
    # NVCC isn't compatible with the Intel compiler
    set(PV_USE_CUDA OFF CACHE BOOL "${PV_USE_CUDA_HELP}")
  elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
    ...
    set(PV_CPP_FLAGS ${CLANG_CPP_FLAGS})
  elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "AppleClang")
    ...
    set(PV_CPP_FLAGS "${APPLECLANG_CPP_FLAGS}")
  ...
  elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "GNU")
    ...
    set(PV_CPP_FLAGS ${GCC_CPP_FLAGS})
  ...
  if (PV_USE_CUDA)
    if(INTEL_COMPILER_DETECTED)
      ...
      if(CUDA_FOUND AND CUDNN_FOUND)
        ...
        set(CUDA_BASE_FLAGS "${CUDA_BASE_FLAGS};-std=c++17")
