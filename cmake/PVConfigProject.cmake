...
macro(pv_config_project)
  ...
  set(PV_USE_OPENMP_HELP "Defines whether PetaVision uses OpenMP threading")
  set(PV_OPENMP_FLAG_HELP "Compiler flag for compiling with OpenMP")
  set(PV_USE_TIFF_HELP "Defines whether PetaVision can read TIFFs (requires libtiff include headers)")
  set(PV_USE_CUDA_HELP "Defines whether PetaVision uses CUDA GPU")
  set(PV_CUDA_RELEASE_HELP "Defines whether CUDA compiles with optimization")
  set(PV_CUDA_ARCHITECTURE_HELP "Defines CUDA architecture to compile for")
  set(PV_CUDNN_PATH_HELP "Location of cuDNN libraries. Required if PV_USE_CUDA is on.")
  ...
  set(PV_DEBUG_OUTPUT_HELP "Display output from DebugLog() in Release builds")
  ...
  elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "GNU")
    ...
    if (${CMAKE_CXX_COMPILER_VERSION} VERSION_LESS "4.3")
      message(FATAL_ERROR "PetaVision requires GCC version 4.3 or greater (detected ${CMAKE_CXX_COMPILER_VERSION})")
    endif()
    set(COMPILER_DETECTED ON)
  ...
  set(PV_USE_TIFF OFF CACHE BOOL "${PV_USE_TIFF_HELP}")
  ...
  if (PV_USE_TIFF)
    ...
    if (TIFF_FOUND)
      ...
      message(FATAL_ERROR "TIFF was not found. PV_USE_TIFF=ON requires the libtiff include headers.")
    endif()
  endif()
