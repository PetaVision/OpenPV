...
namespace PV {
    ...
    inverseNewCochlearLayer::inverseNewCochlearLayer(const char * name, HyPerCol * hc) {
        initialize_base();
        initialize(name, hc);
    }  // end inverseNewCochlearLayer::inverseNewCochlearLayer(const char *, HyPerCol *)
    ...
    int inverseNewCochlearLayer::initialize(const char * name, HyPerCol * hc) {
