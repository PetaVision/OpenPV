...
switch numDim(mat)
    ...
    case 2
        ...
        mat_new = edge_val*ones(x_new, y_new);
        ...
        if extend_edges        
            ...
            mat_new(1:x1-1, 1:y1-1) = mat(1, 1)*ones(x1_size, y1_size);
            mat_new(1:x1-1, y2+1:end) = mat(1, end)*ones(x1_size, y2_size);
            mat_new(x2+1:end, 1:y1-1) = mat(end, 1)*ones(x2_size, y1_size);
            mat_new(x2+1:end, y2+1:end) = mat(end, end)*ones(x2_size, y2_size);
        end    
    ...
    case 3
        ...
        mat_new = edge_val*ones(x_new, y_new, z_new);
        ...
        if extend_edges        
            ...
            mat_new(1:x1-1, 1:y1-1, 1:z1-1) = mat(1, 1, 1)*ones(x1_size, y1_size, z1_size);
            mat_new(1:x1-1, y2+1:end, 1:z1-1) = mat(1, end, 1)*ones(x1_size, y2_size, z1_size);
            mat_new(1:x1-1, 1:y1-1, z2+1:end) = mat(1, 1, end)*ones(x1_size, y1_size, z2_size);
            mat_new(1:x1-1, y2+1:end, z2+1:end) = mat(1, end, end)*ones(x1_size, y2_size, z2_size);
            mat_new(x2+1:end, 1:y1-1, 1:z1-1) = mat(end, 1, 1)*ones(x2_size, y1_size, z1_size);
            mat_new(x2+1:end, y2+1:end, 1:z1-1) = mat(end, end, 1)*ones(x2_size, y2_size, z1_size);
            mat_new(x2+1:end, 1:y1-1, z2+1:end) = mat(end, 1, end)*ones(x2_size, y1_size, z2_size);
            mat_new(x2+1:end, y2+1:end, z2+1:end) = mat(end, end, end)*ones(x2_size, y2_size, z2_size);
