...
plot_flag = true;
output_dir = "/Volumes/mountData/PASCAL_VOC/PASCAL_S1_1536_ICA/VOC2007_landscape10";
%%output_dir = "/Volumes/mountData/PASCAL_VOC/PASCAL_S1X4_1536_ICA/VOC2007_landscape2";

%%draw reconstructed image
DoG_weights = [];
Recon_list = {["a4_"],  ["Image"]};
%%Recon_list = {["a6_"],  ["Image"]};
...
for i_scale = 1 : 1 
  gt_classID_file = fullfile("/Volumes/mountData/PASCAL_VOC/PASCAL_S1_1536_ICA/VOC2007_landscape10/a6_GroundTruth.pvp")
  %%gt_classID_file = fullfile("/Volumes/mountData/PASCAL_VOC/PASCAL_S1X4_1536_ICA/VOC2007_landscape2/a7_GroundTruth.pvp")
  if i_scale == 1
    pred_classID_file = fullfile("/Volumes/mountData/PASCAL_VOC/PASCAL_S1_1536_ICA/VOC2007_landscape10/a8_GroundTruthReconS1.pvp")
    %%pred_classID_file = fullfile("/Volumes/mountData/PASCAL_VOC/PASCAL_S1X4_1536_ICA/VOC2007_landscape2/a2_GroundTruthReconS1.pvp")
  endif
