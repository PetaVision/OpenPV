...
switch kgrid.dim
    ...
    case 2
        ...
        if numel(c) == 1
            subplot(2, 2, 3), imagesc(kgrid.y_vec(y1:y2)*scale, kgrid.x_vec(x1:x2)*scale, double(c)*ones(size(p(x1:x2, y1:y2))), [plot_zlim(1) - plot_spc*plot_rng, plot_zlim(2) + plot_spc*plot_rng]);
        else
        ...
        plot_rng = plot_zlim(2) - plot_zlim(1);
        if numel(rho0) == 1
            subplot(2, 2, 4), imagesc(kgrid.y_vec(y1:y2)*scale, kgrid.x_vec(x1:x2)*scale, double(rho0)*ones(size(p(x1:x2, y1:y2))), [plot_zlim(1) - plot_spc*plot_rng, plot_zlim(2) + plot_spc*plot_rng]);
        else
