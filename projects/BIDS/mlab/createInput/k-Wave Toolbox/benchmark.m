...
options.smooth = [true, false, false];
...
start_size = 32;
x_scale_array = [1 2 2 2 4 4 4 8 8 8];
y_scale_array = [1 1 2 2 2 4 4 4 8 8];
z_scale_array = [1 1 1 2 2 2 4 4 4 8];
    ...
    for size_index = 1:length(x_scale_array)
        ...
        for loop_num = 1:options.num_averages
            ...
            if options.report_mem_usage
                ...
                [sensor_data, field_data, mem] = kspaceFirstOrder3D(kgrid, medium, source, sensor, input_args{:});
