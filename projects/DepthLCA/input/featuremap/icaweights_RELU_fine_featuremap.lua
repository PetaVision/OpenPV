...
local V1File = "~/mountData/benchmark/icaweights_binoc_RELU_fine/a12_V1.pvp";
...
params["column"] = {
   ...
   stopTime = 1; 
   progressStep = 10;
   outputPath = "/home/ec2-user/mountData/benchmark/featuremap/icaweights_binoc_RELU_fine/";
