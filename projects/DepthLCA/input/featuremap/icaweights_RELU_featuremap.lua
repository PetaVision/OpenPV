...
local leftDictFile = "/home/ec2-user/mountData/dictLearn/leftDict.pvp";
local rightDictFile = "/home/ec2-user/mountData/dictLearn/rightDict.pvp";
local V1File = "~/mountData2/benchmark/icaweights_RELU/a12_V1.pvp";
...
params["column"] = {
   ...
   stopTime = 1; 
   progressStep = 10;
   outputPath = "/home/ec2-user/mountData/benchmark/featuremap/icaweights_RELU/";
