...
package.path = package.path .. ";" 
            .. os.getenv("HOME") 
            .. "/workspace/pv-core/parameterWrapper/?.lua";
...
local leftDictFile =  "/home/ec2-user/mountData/benchmark/icaweights_binoc_LCA/Checkpoints/Checkpoint194000/V1ToLeftError_W.pvp";
local rightDictFile = "/home/ec2-user/mountData/benchmark/icaweights_binoc_LCA/Checkpoints/Checkpoint194000/V1ToRightError_W.pvp";
local V1File = "~/mountData/benchmark/icaweights_binoc_RELU/a12_V1.pvp";
...
params["column"] = {
   ...
   stopTime = 1; 
   progressStep = 10;
   outputPath = "/home/ec2-user/mountData/benchmark/featuremap/icaweights_binoc_RELU/";
