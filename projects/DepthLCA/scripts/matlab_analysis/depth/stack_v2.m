...
output_dir = "/nh/compneuro/Data/Depth/LCA/stack_v2/"; 
   ...
   for i_weights = 1:num_weights_list
      ...
      for i_arbor = 1:numarbors
       ...
       if(~isempty(depthHistVal))
          ...
          [depth_hist, depth_hist_bins] = hist(depthHistVal(:), numDepthBins);
          bar(depth_hist_bins, (depth_hist)./numDepthHist);
