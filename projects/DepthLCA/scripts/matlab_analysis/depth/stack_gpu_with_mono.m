...
output_dir = "/nh/compneuro/Data/Depth/LCA/stack_with_mono_gpu/"; 
...
if analyze_nonSparse_flag
    ...
    nonSparse_norm_strength = [.0294 .0294];
    Sparse_std_ndx = [0 0];
    plot_flag = true;
...
if plot_weights
   weights_list = ...
       { ...
        ...
        ["V1S4ToRightError_W"]; ...
        ["V1S8ToRightError_W"]; ...
        ["monoV1S2ToLeftError_W"]; ...
        ["monoV1S4ToLeftError_W"]; ... 
        ["monoV1S8ToLeftError_W"]; ... 
        };
   pre_list = ...
       { ...
        ["V1S2_A"]; ...
