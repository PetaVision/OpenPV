...
param_template_name = 'retina_params_heli.template'
...
run_path            = wrkspc_path+'/HyPerRetina/Debug_remote/HyPerRetina'

## INPUT MOVIE (One should be uncommented)
input_movie = remote_input_path+'/filenames_graywhiteblackspots.txt'#'/heli_challenge_026_framenames.txt'
