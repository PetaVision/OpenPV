function [Sparse_hdr, ...
  ...
  for i_Sparse = 1 : num_Sparse_list
	...
	save("-mat", ...
      ...
      if save_Sparse_hist_pool_flag && max2X2_pool_flag
	save("-mat", ...
	     [Sparse_dir, filesep, "max2X2_", Sparse_filename_id, ".mat"], ...
	     "Sparse_max2X2_pool");
      endif
      if save_Sparse_hist_pool_flag && mean2X2_pool_flag
	save("-mat", ...
	     [Sparse_dir, filesep, "mean2X2_", Sparse_filename_id, ".mat"], ...
	     "Sparse_mean2X2_pool");
      endif
      if save_Sparse_hist_pool_flag && max4X4_pool_flag
	save("-mat", ...
	     [Sparse_dir, filesep, "max4X4_", Sparse_filename_id, ".mat"], ...
	     "Sparse_max4X4_pool");
      endif
      if save_Sparse_hist_pool_flag && mean4X4_pool_flag
	save("-mat", ...
