function [pvp_params_file pvp_project_path pvp_output_path] = pvp_makeSTDPParams(DATASET_ID, ...
  ...
  num_argin = num_argin + 1;
  if nargin < num_argin || ~exist("pvp_params_templatein") || isempty(pvp_params_templatein)
    pvp_params_template = [pvp_project_path, "templates", filesep, DATASET_ID, "_", "template.params"];
  else
    pvp_params_template = [pvp_project_path, "templates", filesep, pvp_params_templatein, "_", "template.params"];
  endif
  ...
  if nargin < num_argin || ~exist("pvp_output_path") || isempty(pvp_output_path)
    pvp_output_path = [pvp_project_path , "output", filesep, pvp_params_templatein, filesep, DATASET_ID];
  ...
  pvp_params_hash = ...
      {"numSteps", "numSteps", num2str(pvp_num_frames); ...
       ...
       "wMin", "wMin", params{15};...
       "wMax", "wMax", params{16};...
       "synscalingFlag", "synscalingFlag", params{17};...
       "synscaling_v", "synscaling_v", params{18};...
       "movieMarginWidth", "marginWidth", params{19};...
       "useImageBCflag", "useImageBCflag", params{20};...
       };
