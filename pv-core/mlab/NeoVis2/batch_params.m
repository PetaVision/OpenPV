...
clip_ids = [26:50]; %% [7:17,21:22,30:31];
...
NEOVISION_DISTRIBUTION_ID = "Challenge";
...
pvp_input_path = ...
    [pvp_clique_path, "input", filesep, ...
     NEOVISION_DATASET_ID, filesep, ...
     NEOVISION_DISTRIBUTION_ID, filesep];
pvp_object_type =  "Plane"; %% "Car"; %%
pvp_num_ODD_kernels =  3; %%
pvp_edge_type =  "canny"; %%
pvp_bootstrap_str = ""; %% "_bootstrap"; %% 
pvp_version_str = "2"; %% ""; %%  append to pvp_edge_type to denote version number of output
pvp_params_template = ...
...
%% make activity dirs
  ...
  mkdir([pvp_activity_path, clip_name{i_clip}, filesep, ...
	 pvp_object_type, num2str(pvp_num_ODD_kernels), pvp_bootstrap_str, filesep, pvp_edge_type, pvp_version_str, filesep])
