...
//
// update the state of an LabelErrorLayer
//
...
{
  updateV_LabelErrorLayer(nbatch, numNeurons, V, GSynHead, activity, AMax, AMin, Vth, AShift, nx, ny, nf, lt, rt, dn, up, errScale, isBinary);
}
