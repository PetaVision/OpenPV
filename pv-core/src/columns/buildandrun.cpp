...
// which use the PV_Factory class, are the preferred versions of these
...
// This version of buildandrun was deprecated March 24, 2016 in favor of the PV_Factory version.
int buildandrun(int argc, char * argv[],
      int (*custominit)(HyPerCol *, int, char **),
      int (*customexit)(HyPerCol *, int, char **),
...
// This version of rebuildandrun was deprecated March 24, 2016 in favor of the PV_Factory version.
int rebuildandrun(PV_Init* initObj,
      int (*custominit)(HyPerCol *, int, char **),
      int (*customexit)(HyPerCol *, int, char **),
      void * (*customgroups)(const char *, const char *, HyPerCol *)) {
...
// This version of buildandrun1paramset was deprecated March 24, 2016 in favor of the PV_Factory version.
int buildandrun1paramset(PV_Init* initObj,
                         int (*custominit)(HyPerCol *, int, char **),
                         int (*customexit)(HyPerCol *, int, char **),
                         void * (*customgroups)(const char *, const char *, HyPerCol *)) {
...
// This version of build was deprecated March 24, 2016 in favor of the PV_Factory version.
HyPerCol * build(PV_Init* initObj,
                 void * (*customgroups)(const char *, const char *, HyPerCol *)) {
