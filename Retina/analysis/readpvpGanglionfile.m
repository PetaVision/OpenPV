%function [numframes,activity] = readpvpfileNrun
...
clear all; close all; more off;
  ...
  filename = ['../output/ImageReconstruct/300ms/GanglionON.pvp'];

global output_path;  output_path  = '~/Documents/workspace/Retina/read_pvp_output';
%global filename;     filename     = '~/Documents/workspace/Retina/output/a12_GanglionON.pvp'
...
global FNUM_SPEC;    FNUM_SPEC    = '1:250:500'; %can be '-1', 'int(frame)', or 'start:int:end'
