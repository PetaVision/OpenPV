%% Combines the reconstructed images from the three layers of the stack and places
%%    all reconstructions from a set in a new folder corresponding to the timestep
