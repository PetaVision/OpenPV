...
elseif isunix
  ...
  output_dir = "/nh/compneuro/Data/Depth/LCA/dataset01_arbor"; 
endif
...
if plot_weights
   ...
   for i_weights = 1:num_weights_list
      ...
      for i_arbor = 1:numarbors
       ...
       saveas(weights_hist_fig, [weights_dir, filesep, "weights_hist_", weight_list{i_weights}, "_", num2str(i_arbor), "_", num2str(weight_time)], "png");
    endfor %% i_arbors
  endfor %% i_weights
endif  %% plot_weights
