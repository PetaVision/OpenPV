...
output_dir = "/home/ec2-user/mountData/LCA_train_single_group_nf_512/"; 
...
if analyze_nonSparse_flag
    ...
    nonSparse_norm_strength = [.00735 .00735];
    Sparse_std_ndx = [0 0];
    plot_flag = true;
...
plot_xCorr = 1;
if plot_xCorr
   xCorr_frames_calc = 20; %from the end, 0 to calculate all
   xCorr_list= ...
       {...
        ["a8_LCA_V1"]; ...
        };
