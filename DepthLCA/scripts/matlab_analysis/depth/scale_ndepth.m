...
output_dir = "/nh/compneuro/Data/Depth/LCA/depth_log_scale_ndepth/"; 
...
if plot_recon_err
   ...
   {["a14_"], ["LeftRecon1"];...
    ...
    ["a39_"], ["RightRecon2"];...
    ["a40_"], ["RightRecon3"];...
    ["a47_"], ["RightDepthRecon"];...
    ["a52_"], ["PosRecon"];...
   };

   ReconError_skip = [1, 1, 1, 1, 1, 1, 1, 1, 1];

   ReconError_norm_list = ...
   { ["a8_"], ["LeftRescale1"];...
     ["a9_"], ["LeftRescale2"];...
    ["a10_"], ["LeftRescale3"];...
    ["a21_"], ["LeftDepthRescale"];...
    ["a32_"], ["RightRescale1"];...
    ["a33_"], ["RightRescale2"];...
    ["a34_"], ["RightRescale3"];...
    ["a45_"], ["RightDepthRescale"];...
    ["a50_"], ["PosRescale"];...
   };

   Recon_norm_strength = ...
   [.0624, .0624, .0588, .17677, .0624, .0624, .0588, .17677, .44721];

   plot_ReconError_flag = true;
   fraction_ReconError_frames_read = 1;
   min_ReconError_skip = 1;
   fraction_ReconError_progress = 1;
