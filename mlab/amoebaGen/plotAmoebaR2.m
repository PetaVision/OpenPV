function plotAmoebaR2(amoeba_image, amoeba_struct, trial, nfourier)
%global w0
global image_dim
...
%savefile(['256_png/',num2str(nfourier),'/m/m_',suffix_zeros, num2str(t)], 128, 128);
% savefile(['128_png/',num2str(nfourier),'/m/m_',suffix_zeros, num2str(t)], 64, 64);
