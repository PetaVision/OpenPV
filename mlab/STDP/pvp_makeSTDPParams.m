function [pvp_params_file pvp_project_path pvp_output_path] = pvp_makeSTDPParams(DATASET_ID, ...
  ...
  pvp_params_hash = ...
      {"numSteps", "numSteps", num2str(pvp_num_frames); ...
       ...
       "checkpointReadDir", "checkpointReadDir", ["""", "./checkpoints/", params{3}, """"]; ...
       "checkpointWriteDir", "checkpointWriteDir", ["""", "./checkpoints/" params{3}, """"]; ...
       "checkpointReadDirIndex", "checkpointReadDirIndex", params{4}; ...
       "checkpointWriteStepInterval", "checkpointReadDirIndex", params{5}; ...
       "printParamsFilename", "printParamsFilename", ["""", params{3}, """"]; ...
       };
