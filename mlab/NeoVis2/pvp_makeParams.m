function [pvp_params_file, pvp_params_path] = ...
  ...
  num_argin = num_argin + 1;
  if nargin < num_argin || ~exist("pvp_bootstrap_str") || isempty(pvp_bootstrap_str)
  ...
  pvp_params_hash = ...
      {"nx", "nx",num2str(pvp_frame_size(2)); ...
       ...
       "VgainL1Clique", "Vgain", num2str(0.0625); ...
       "VgainL2Clique", "Vgain", num2str(0.125); ...
       "VgainL3Clique", "Vgain", num2str(0.125); ...
       "VgainL4Clique", "Vgain", num2str(0.125); ...
       };
