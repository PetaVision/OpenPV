function [pvp_params_file] = ...
  ...
  pvp_params_hash = ...
      {"numSteps", "numSteps", num2str(pvp_num_frames + 2*pvp_num_ODD_kernels + 4); ...
       ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL2ToL2CliqueTarget", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{1}, """"]; ...  
       "initWeightsFileL2ToL2PostTarget", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{1}, """"]; ...  
       "initWeightsFileL2ToL2CliqueDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL2ToL2PostDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL3ToL3CliqueTarget", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{1}, """"]; ...  
       "initWeightsFileL3ToL3PostTarget", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{1}, """"]; ...  
       "initWeightsFileL3ToL3CliqueDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL3ToL3PostDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"] ...
       };
