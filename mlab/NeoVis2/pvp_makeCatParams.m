function [pvp_params_file] = ...
  ...
  pvp_params_hash = ...
      {"numSteps", "numSteps", num2str(pvp_num_frames + 2*pvp_num_ODD_kernels + 4); ...
       ...
       "initWeightsFileL1Pool1X1toL1PostDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL2Pool2X2toL2PostDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL3Pool4X4toL3CliqueTarget", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{1}, """"]; ...  
       "initWeightsFileL3Pool4X4toL3PostTarget", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{1}, """"]; ...  
       "initWeightsFileL3Pool4X4toL3CliqueDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"]; ...
       "initWeightsFileL3Pool4X4toL3PostDistractor", "initWeightsFile", ...
       ["""", pvp_file_of_weights_file{2}, """"] ...
       };
