...
if clips_flag 
  ...
  clip_name = cell(1);
  clip_name{1} = "026"; %% "mask"; %% "Car_bootstrap0"; %% "Plane"; %% "distractor"; %% 
endif
%% chip_path is the path to the folders referenced by clip_name 
chip_path = "/mnt/data/repo/neovision-programs-petavision/Heli/Challenge/canny/";
chip_path_append = ""; %% "8FC";
petavision_dir = ...
    ["/mnt/data/repo/neovision-programs-petavision", filesep];
dataset_dir = [petavision_dir, "Heli", filesep]; 
flavor_dir = [dataset_dir, "Challenge", filesep]; 
