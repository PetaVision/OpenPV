...
for i_clip = 1 : length(clip_name)
  ...
  pvp_path = [program_path, "activity", filesep, ...
	      clip_name{i_clip}, filesep, ObjectType, num2str(num_ODD_kernels), pvp_bootstrap_str, filesep, pvp_edge_filter, filesep];
  ...
  csv_file = ...
      [program_path, "results", filesep, clip_name{i_clip}, filesep, ...
       ObjectType, num2str(num_ODD_kernels), pvp_bootstrap_str, filesep, pvp_edge_filter, filesep, ...
       NEOVISION_DATASET_ID, "_", NEOVISION_DISTRIBUTION_ID, "_",  clip_name{i_clip}, "_PetaVision_", ObjectType, "_003", ".csv"]  
  csv_repo = ...
