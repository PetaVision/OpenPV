function [pvp_params_file] = ...
  ...
  if nargin < num_argin || ~exist("FLAVOR_ID") || isempty(FLAVOR_ID)
    FLAVOR_ID = "Training"; %% "33x33"; %% "3way"; %% "Challenge"; %% "Formative"; %%  
  endif
  ...
  if nargin < num_argin || ~exist("pvp_params_template") || isempty(pvp_params_template)
	...
	[pvp_clique_path, ...
	 ...
	 DATASET_ID, filesep, ...
	 FLAVOR_ID, filesep, ...
	 pvp_object_type, pvp_num_ODD_kernels_str, filesep, ...
	 DATASET_ID, "_", FLAVOR_ID, "_", ...
	 pvp_object_type, num2str(pvp_num_ODD_kernels), pvp_bootstrap_str, "_", pvp_edge_type, pvp_clique_id, "_", pvp_version_str,  "_", ...
	 "template.params"];
  endif
  ...
  pvp_params_hash = ...
      {"numSteps", "numSteps", num2str(pvp_num_frames + pvp_num_ODD_kernels + 4); ...
       ...
       "VgainL1Clique", "Vgain", num2str(0.5, "%5.3f"); ...
       "VgainL2Clique", "Vgain", num2str(0.5, "%5.3f"); ...
       "VgainL3Clique", "Vgain", num2str(0.5, "%5.3f"); ...
       "VgainL4Clique", "Vgain", num2str(0.5, "%5.3f"); ...
       "VgainL5Clique", "Vgain", num2str(0.5, "%5.3f"); ...
       "VgainL6Clique", "Vgain", num2str(0.5, "%5.3f"); ...
       };
%%  pvp_params_hash = ...
