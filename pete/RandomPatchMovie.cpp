...
RandomPatchMovie::RandomPatchMovie(const char * name, HyPerCol * hc) : Image(name, hc) {
   initialize_base();
}

RandomPatchMovie::RandomPatchMovie(const char * name, HyPerCol * hc,
                                   const char * fileOfFileNames,
                                   float displayPeriod) :
      Image(name, hc)
{
   initialize_base();
   initializeRandomPatchMovie(name, hc, fileOfFileNames, displayPeriod);
}
...
int RandomPatchMovie::initializeRandomPatchMovie(const char * name, HyPerCol * hc, const char * fileOfFileNames, float defaultDisplayPeriod) {
#ifdef PV_USE_MPI
